...
| # | Nombre | Descripción |
|---|--------|-------------|
| 00 | `00_generate_model.ipynb` | Generación y validación del stack de datos base |
| 01 | `01_explore_stack.ipynb` | Exploración visual de variables por región |
| 02 | `02_preprocess_data.ipynb` | Preparación de datos para autoencoder |
